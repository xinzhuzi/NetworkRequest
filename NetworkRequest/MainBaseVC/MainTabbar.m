...
- (void)viewDidLoad {
    ...
    NSMutableArray *arrayVC =@[@"GeneralRequest_VC",@"SpecialRequest_VC",@"DownloadRequest_VC",@"UploadRequest_VC"].mutableCopy;
    ...
    for (NSInteger i = 0; i<arrayVC.count; i++) {
        ...
        Nav_Base_VC *thisNav=[self viewController:VC.new title:@[@"普通",@"特殊",@"下载",@"上传"][i] image:[UIImage imageNamed:imageArray[i]] selectedImage:[UIImage imageNamed:sImageArray[i]]];
